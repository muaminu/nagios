...
3. Run `ansible-vault edit secrets.yml`
   * It may ask you for the password three times, this is a known ansible bug
4. Enter password `nagiosxi` as this is the example used
   * Feel free to change this as you see fit
5. File will look something like this, update to suit your environment:
